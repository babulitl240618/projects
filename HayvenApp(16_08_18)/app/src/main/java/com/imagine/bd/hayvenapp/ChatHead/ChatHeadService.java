package com.imagine.bd.hayvenapp.ChatHead;
...
public class ChatHeadService extends Service {
	...
	private TextView txt1, messageText;
	...
	private void handleStart(){
		...
		messageText = chatheadView.findViewById(R.id.messageTextId);
		messageText.setText(PersistData.getStringData(context, AppConstant.userTextChatHead));

		Picasso.with(context)
				//   .load(PersistData.getStringData(con, AppConstant.person_pic_url))
				.load(API_URL.PHOTO_BASE_URL + PersistData.getStringData(context, AppConstant.userImgChatHead))
