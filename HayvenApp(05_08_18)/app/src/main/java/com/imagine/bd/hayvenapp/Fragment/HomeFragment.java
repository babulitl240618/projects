        ...
        listChats.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ((tempArrayList != null)) {
                    ...
                    PersistData.setStringData(con, AppConstant.reciverid, tempArrayList.get(position).getId());
                    ...
                    PersistData.setStringData(con, AppConstant.reciverid, getUserListfromDB().get(position).getId());
                    startActivity(new Intent(con, ChattingActivity.class));
                }
                ...
                listCall.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if ((tempArrayList != null)) {
                            ...
                            PersistData.setStringData(con, AppConstant.friend_name, getUserListfromDB().get(position).getFullname());
                            PersistData.setStringData(con, AppConstant.userImg, getUserListfromDB().get(position).getImg());
                            PersistData.setStringData(con, AppConstant.reciverid, getUserListfromDB().get(position).getId());
                            startActivity(new Intent(con, CallInfoActivity.class));
                        }
