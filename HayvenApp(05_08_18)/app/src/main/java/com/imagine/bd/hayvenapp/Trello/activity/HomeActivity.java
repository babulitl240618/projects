...
public class HomeActivity extends AppCompatActivity
    ...
    private TextView initials, fullname, username;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initials = hView.findViewById(R.id.initialsId);
        fullname = hView.findViewById(R.id.fullnameId);
        username = hView.findViewById(R.id.usernameId);

        mModel = TrelloModel.getInstance();
        MemberVO user = mModel.getUser();

        initials.setText(user.initials);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            startActivity(new Intent(HomeActivity.this, BoardActivityGroup.class));
