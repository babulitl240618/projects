...
public class JoinGroupCallActivity extends AppCompatActivity implements AllUserListAdapter.AdapterCallback {
    ...
    AllUserListAdapter mAdapter;
    JoinGroupAdapter mAdapter1;
    private Context con;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_join_group_call);
      ...
      /*  DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(listGroupChats.getContext(),
                linearLayoutManager.getOrientation());
        listGroupChats.addItemDecoration(dividerItemDecoration);*/
        listGroupChats.setHasFixedSize(true);
        listGroupChats.setLayoutManager(new LinearLayoutManager(con));
        Log.e("check", getUserListfromDB().size()+"");


       // mAdapter= new AllUserListAdapter(AppConstant.alluserlist,con);
        mAdapter1= new JoinGroupAdapter(getUserListfromDB(),con);
        listGroupChats.setAdapter(mAdapter1);
    ...
    public void connectToRoom1(String roomId, boolean commandLineRun, boolean loopback,
...
*/
    ...
    public void onMethodCallback() {
        connectToRoom1(PersistData.getStringData(con,AppConstant.rom_id), false, false, false, 0);
    }
