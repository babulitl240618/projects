...
import com.imagine.bd.hayvenapp.AppRTCAudioManager;
...
public class CalingActivity extends AppCompatActivity {
    ...
    /*this ui*/
    ImageView imageView, imgBack, imgHangUp, imgprofile, imgSpeaker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializedConectActivity();
         ...
         mediaPlayer = MediaPlayer.create(this, R.raw.outgoingtone);
           mediaPlayer.start();
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(Config.REGISTRATION_COMPLETE)) {
                    ...
                    String call_answer_type = intent.getStringExtra("calltype");
                    String calling_type = intent.getStringExtra("type");


                    //  startActivity(new Intent(con,IncomingCallActivity.class));
                    Log.e("call_answer_type", call_answer_type);
                    Log.e("type_audio_vedio a", PersistData.getStringData(getApplicationContext(), AppConstant.call_audio_vedio));
                    Log.e("calling_type a", calling_type);

                    // Toast.makeText(con,calling_type+" ,...a",Toast.LENGTH_LONG).show();

                   // Toast.makeText(con, PersistData.getStringData(getApplicationContext(), AppConstant.call_audio_vedio) + " ...b", Toast.LENGTH_LONG).show();

                    if (call_answer_type.equalsIgnoreCase(Config.ACCEPT_CALL)) {

                        if (calling_type.equalsIgnoreCase("vedio")) {
                            connectToRoomVedio(PersistData.getStringData(CalingActivity.this, AppConstant.rom_id), false, false, false, 0);
                            // Toast.makeText(con, calling_type, Toast.LENGTH_LONG).show();
                        } else {
                            connectToRoomAudio(PersistData.getStringData(CalingActivity.this, AppConstant.rom_id), false, false, false, 0);
                            // Toast.makeText(con, calling_type, Toast.LENGTH_LONG).show();
                        }
    ...
    public void initUI() {
       ...
       /* //   dotprogresbar = (DotProgressBar) findViewById(R.id.dot_progress_bar);
        String name = getIntent().getStringExtra("name");
        String image = getIntent().getStringExtra("image");*/


        tvname.setText(findNameById(PersistData.getStringData(con,AppConstant.reciverid)));
        Picasso.with(con)
       ...
       /* imageView.setOnClickListener(new View.OnClickListener() {
        ...
        imgSpeaker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isloudSpeaker) {
                    isloudSpeaker = false;
                    AppRTCAudioManager.AudioDevice.SPEAKER_PHONE.equals(false);
                    Toast.makeText(con, "false", Toast.LENGTH_LONG).show();
                } else {
                    isloudSpeaker = true;
                    AppRTCAudioManager.AudioDevice.SPEAKER_PHONE.equals(true);
                    Toast.makeText(con, "true", Toast.LENGTH_LONG).show();
                }
